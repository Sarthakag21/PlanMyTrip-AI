...
itineary_prompt = ChatPromptTemplate([
    ("system", "You are a helpful travel assisstant. Create a day trip itineary for {city} based on user's interest : {interests}. Provide a Detailed, bulleted itineary"),
